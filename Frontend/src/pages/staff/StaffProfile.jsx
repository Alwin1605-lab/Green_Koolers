...
function StaffProfile() {
  ...
  const roleColor = user?.role === 'admin' ? 'purple' : 'slate'
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="shrink-0 text-sm font-medium text-slate-600 hover:text-slate-900 whitespace-nowrap"
            >
              Skip for now
            </button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <Card.Content className="p-6 text-center">
              {profile.photoUrl ? (
                <img src={profile.photoUrl} alt={profile.name || 'Staff'} className="mx-auto h-20 w-20 rounded-full object-cover" />
              ) : (
              ...
              <h3 className="mt-4 text-lg font-semibold text-slate-900">{profile.name || 'Staff'}</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Contact the system administrator for account assistance.
                  </p>
                </div>
              </div>
            </Card.Content>
