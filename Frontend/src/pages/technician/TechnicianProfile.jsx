        ...
        <div className="space-y-6">
          ...
          <Card>
            <Card.Content className="p-6 text-center">
              {profile.photoUrl ? (
                <img src={profile.photoUrl} alt={profile.name || 'Technician'} className="mx-auto h-20 w-20 rounded-full object-cover" />
              ) : (
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-blue-600 text-2xl font-bold text-white">
                  {profile.name?.split(' ').map(n => n[0]).join('').toUpperCase() || 'T'}
                </div>
              )}
              <h3 className="mt-4 text-lg font-semibold text-slate-900">{profile.name || 'Technician'}</h3>
              ...
              {profile.specialization && (
                <p className="mt-3 text-sm text-slate-600">{profile.specialization}</p>
              )}
            </Card.Content>
          </Card>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Contact your supervisor or the admin team for support.
                  </p>
                </div>
              </div>
            </Card.Content>
